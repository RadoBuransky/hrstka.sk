...
sealed class MongoVoteRepository[TEntity <: Vote : ClassTag](coll: MongoCollection,
...
@Singleton
final class MongoTechVoteRepository @Inject()(reactiveMongoApi: ReactiveMongoApi)
  extends MongoVoteRepository[TechVote](TechVoteCollection, reactiveMongoApi) with TechVoteRepository

@Singleton
final class MongoCompVoteRepository @Inject()(reactiveMongoApi: ReactiveMongoApi)
  extends MongoVoteRepository[CompVote](CompVoteCollection, reactiveMongoApi) with CompVoteRepository